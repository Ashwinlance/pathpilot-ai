...
export type RoleDefinition = {
  ...
  title: string;
  description: string;
  requiredCompetencies: Record<string, number>; // competency id -> required score (0-100)
};

export const DOMAINS: Record<DomainId, { name: string; description: string; color: string }> = {
  statistical: {
    name: 'Statistical System',
    description: 'Core statistical methodologies, survey designs, and national standards for official statistics.',
    color: 'hsl(172 47% 22%)',
  },
  technical: {
    name: 'Technical & Data Science',
    description: 'Programming, data analytics, database querying, data visualization, and AI/ML tools.',
    color: 'hsl(197 45% 35%)',
  },
  governance: {
    name: 'Digital Governance',
    description: 'Government cloud standards, data privacy, cybersecurity, and digital public infrastructure.',
    color: 'hsl(215 50% 40%)',
  },
  managerial: {
    name: 'Behavioural & Managerial',
    description: 'Public leadership, project management, communications, and decision ethics.',
    color: 'hsl(30 48% 38%)',
  },
};
...
export const DEMO_ROLES: RoleDefinition[] = [
  {
    ...
    description: 'Responsible for compiling statistical reports, survey data validation, and basic Python & SQL analytics.',
  ...
  {
    id: 'stat_officer',
    title: 'Statistical Officer (SSO / JSO)',
    description: 'Oversees field survey execution, sampling validation, National Accounts processing, and team reporting.',
    requiredCompetencies: {
      stat_survey_design: 85,
      stat_sampling: 80,
      stat_national_accounts: 75,
      stat_data_quality: 85,
      tech_python: 60,
      tech_sql: 65,
      tech_r: 55,
      mgt_proj_mgt: 75,
  ...
  {
    id: 'data_analyst',
    title: 'Data Analyst (Official Statistics)',
    description: 'Focuses on deep data processing, database querying, automated ETL pipelines, and interactive visualization dashboards.',
    requiredCompetencies: {
      tech_python: 85,
      tech_sql: 85,
      tech_datavis: 80,
  ...
  {
    id: 'research_officer',
    title: 'Research Officer (Econometrics & Policy)',
    description: 'Conducts macro-economic modeling, price statistics analysis, SDG indicator tracking, and policy impact assessments.',
    requiredCompetencies: {
      stat_national_accounts: 85,
      stat_price_stats: 80,
      stat_sdg: 80,
      tech_r: 75,
      tech_stata: 70,
  ...
  },
  {
    ...
    description: 'Strategic leadership for modernizing statistical systems, cloud architecture, AI/ML adoption, and digital governance.',
    requiredCompetencies: {
      tech_aiml: 85,
      tech_cloud: 80,
      tech_python: 80,
